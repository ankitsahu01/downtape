    ...
    <>
      ...
      >
        <Typography component="h2" variant="h5" align="center">
          <Box mb={3}>How To Download YouTube Videos?</Box>
        </Typography>
...
const DowntapeYoutubeDownloader = () => {
  const classes = useStyles();
  return (
    <>
      <Paper
      ...
      >
        <Container maxWidth="md">
          <Typography component="h3" variant="h5" align="center" gutterBottom>
            <Box>DownTape YouTube Downloader</Box>
          </Typography>
          <Typography align="justify">
              DownTape Youtube video downloader provides fastest service to download
              videos in mp4, mp3, SQ, HD, Full HD quality from YouTube! For more
