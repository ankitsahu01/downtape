...
const Terms = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Terms of Service - DownTape</title>
      </Helmet>
        ...
        <Container maxWidth="md">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to DownTape.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to DownTape, accessible from{" "}
                <NavLink to="/">https://downtape.herokuapp.com</NavLink>
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            <li>
              <p>
                By email:{" "}
                <a href="mailto:downtape1@gmail.com">downtape1@gmail.com</a>
              </p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{" "}
                <NavLink to="/contact">downtape.herokuapp.com/contact</NavLink>
              </p>
            </li>
          </ul>
        </Container>
